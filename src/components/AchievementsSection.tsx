    ...
    <section id="achievements" className="section-padding">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex justify-center">
          <div className="card-portfolio p-8 md:p-12 rounded-2xl text-center max-w-2xl animate-fade-in-up">
            ...
            <div className="mt-8 pt-6 border-t border-border-soft">
              <span className="font-subtitle text-sm text-primary bg-primary/10 px-4 py-2 rounded-full">
